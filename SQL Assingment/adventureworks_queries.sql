use adventureworks;
-- 1. Write a query to display employee numbers and employee name (first name, last name) of all the sales employees who received an amount 
-- of 2000 in bonus. 
select EmployeeID, FirstName,LastName, bonus  from contact
join employee 
...
select EmployeeID, FirstName from contact
join employee 
on contact.ContactID=employee.ContactID 
